import { Clock, FlaskConical, GraduationCap, Layers } from 'lucide-react'

const stats = [
  { icon: Layers, value: '12 Modules', label: 'Structured curriculum' },
  { icon: Clock, value: '~30 Hours', label: 'Self-paced learning' },
...
export function StatsBar() {
  return (
    <section className="border-b border-border/60 bg-card/40">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-px px-6 py-4 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
